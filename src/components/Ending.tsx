export default function Ending() {
  return (
    <section className="min-h-screen bg-black -mx-6 md:-mx-25 px-6 md:px-25 text-white flex items-center justify-center relative overflow-hidden">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[180%] md:w-[140%] max-w-[150rem] -mt-16 md:-mt-32 opacity-80">
        <img src="./ending-circle-cut.png" alt="" className="w-full h-auto mix-blend-screen" />
      </div>

      <div className="relative z-10 text-center max-w-[140rem] mx-auto py-20 md:py-40 mt-20 md:mt-100 px-4 md:px-0">

...
export default function Products() {
  return (
    <section className="bg-[#fafafa] py-20 md:py-30 -mx-6 md:-mx-25 px-4 md:px-25">
      <div>
        <div>
          <div className="w-[90%] md:w-3/4 lg:w-1/2 h-32 md:h-50 bg-white flex justify-between rounded-[3rem] md:rounded-[8rem] mx-auto p-2 md:p-6 mb-6 text-lg md:text-5xl lg:text-6xl font-semibold">
            <span className="w-1/2 h-full bg-[var(--button-color)] flex justify-center items-center text-white rounded-[2.5rem] md:rounded-[8rem] px-1 md:px-4">
              <p className="text-center leading-tight text-[1.6rem] md:text-[inherit]">
                Things we've built
              </p>
            </span>

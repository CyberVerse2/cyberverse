export default function About() {
  return (
    <section className="min-h-screen w-full flex justify-center items-center px-4 md:px-0">
      <div className="text-white rounded-[2rem] md:rounded-[4.4rem] bg-gradient-to-br from-[#1E1E1E] to-[#03080F] min-h-[calc(100vh-20rem)] flex flex-col md:flex-row justify-between items-center md:items-end p-8 md:p-20 gap-8 md:gap-y-10">
        <div className="md:ml-30 w-full md:w-[90%]">
          <h2 className="text-6xl md:text-9xl font-extrabold pb-3">About Us</h2>
          <p className="text-2xl md:text-[2.8rem] w-full md:w-3/4 pt-5 font-normal">
        ...
        <img src="./about-img.png" alt="" className="w-full md:w-[75%] md:mr-15 self-end" />
      </div>
    </section>
  );
}
